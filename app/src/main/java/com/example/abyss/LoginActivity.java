...
public class LoginActivity extends AppCompatActivity {
    EditText emailIdInput, passwordInput;
    Button signInButton;
    TextView loginText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        emailIdInput = findViewById(R.id.editText);
        ...
        signInButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String email = emailIdInput.getText().toString();
                String pwd = passwordInput.getText().toString();
                if (email.isEmpty()) {
                    emailIdInput.setError("Please enter email id");
